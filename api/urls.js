...
export const REPERTOIRE_UPDATE_URL = `${API_URL}repertoire/update`;
...
export const SECTION_UPDATE_URL = `${API_URL}section/update`;
export const SONG_CREATE_URL = `${API_URL}song/create`;
export const SONG_DELETE_URL = `${API_URL}song/delete`;
